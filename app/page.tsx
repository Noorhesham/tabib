    ...
    <>
      ...
      <div className="flex my-10  w-full flex-col  md:flex-row items-center">
        <MaxWidthWrapper className=" w-[45%] flex flex-col   gap-4">
          <h1 className=" font-bold  text-main text-4xl lg:text-5xl">
            هتلاقي الرعاية المناسبة في احسن العيادات بمصر !
          </h1>
        ...
        <ThreeDSpace className="w-[55%]  h-[80vh]" />
      </div>
      <MaxWidthWrapper>
        <div className=" flex flex-col gap-2">
          <h1 className=" font-bold  text-main text-4xl ">اكتشف حلولنا الشاملة للرعاية الصحية</h1>
        ...
        <MotionContainer className=" grid lg:grid-cols-3 mt-4 grid-cols-1 gap-4">
          {featuredCardsData.map((card, index) => (
            ...
            >
              ...
              <h1 className=" font-semibold  text-main text-xl  mb-2 ">{card.title}</h1>
